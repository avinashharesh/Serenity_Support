      ...
      <div v-if="!isSubmitted" class="appointment-form mx-auto">
        <form @submit.prevent="submitForm">
          <div class="mb-3">
            ...
            <select v-model="form.professional" id="professional" class="form-select" required>
  ...
  methods: {
    ...
    async submitForm() {
      try {
        ...
        const isAvailable = this.isProfessionalAvailable(
        ...
        if (!isAvailable) {
          alert(
            'The selected professional is already booked at the chosen date and time. Please select another slot.'
          )
          return
        }
